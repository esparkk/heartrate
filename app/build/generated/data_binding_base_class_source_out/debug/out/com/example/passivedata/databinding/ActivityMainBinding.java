...
package com.example.passivedata.databinding;
...
import com.example.passivedata.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView appName,
      @NonNull ImageView brokenHeart, @NonNull SwitchMaterial enablePassiveData,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, appName, brokenHeart,
          enablePassiveData, heart, lastMeasuredLabel, lastMeasuredValue, notAvailable, progress);
    }
